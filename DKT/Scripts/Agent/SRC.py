...
# ============================================================================
from mindspore import nn, ops, jit as ms_function, numpy as mnp, dtype
...
class SRC(nn.Cell):
    ...
    def backup(self, targets, initial_logs, initial_log_scores, origin_path, selecting_s):
        ...
        mask = ops.repeat_interleave(mnp.expand_dims(selecting_s, 1), selecting_s.shape[-1], axis=1)  # (B, n, n)
